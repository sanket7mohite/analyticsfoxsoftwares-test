...
public class SampleTestCase1 extends BaseClass {
	
	
	@Test(dataProvider="DataSet")
	public void Test1(String FirstName, String Mobile, String Email) throws IOException, InterruptedException
	{
...
*/	
		...
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		String actualText = driver.findElement(By.xpath("//div[@class='no-offer-info']//h2")).getText();
		String expectedText = "Sorry, no offers available at the moment!";
